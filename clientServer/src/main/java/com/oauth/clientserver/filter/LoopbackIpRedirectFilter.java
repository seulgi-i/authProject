...
// */
//
//package com.oauth.clientserver.filter;
//
...
//			// Extract URI information from the request
//			String scheme = request.getScheme();
//			String host = "127.0.0.1"; // Replace with your desired host
//			String path = request.getRequestURI();
//			int port = request.getServerPort();
//
//			// Create URI using the extracted information
...
//					.toUri();
//
//			// Use the URI to perform the redirection
//			response.sendRedirect(((URI) uri).toASCIIString());
//			return;
//		}
